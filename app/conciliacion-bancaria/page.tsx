...
import { ClipboardList, FileText, Lock, ShieldCheck, Wallet } from "lucide-react";
import Sidebar from "../../components/Sidebar";
import { validarAccesoModuloUsuario } from "../../lib/validarAccesoModuloUsuario";

const resumen = [
  { titulo: "Estados de cuenta", valor: "Pendiente de conectar" },
  { titulo: "Movimientos internos", valor: "Sin conexión todavía" },
  { titulo: "Diferencias", valor: "Pendiente de conectar" },
  { titulo: "Reporte conciliación", valor: "Preparado para fase SQL" },
];
...
const proximosPasos = [
  "Conectar carga de estados de cuenta",
  "Vincular movimientos internos por banco",
  "Preparar reglas de conciliación",
  "Activar ajustes auditados en una rama posterior",
];
    ...
    async function iniciar() {
      try {
        ...
        if (!acceso.ok) {
          ...
          setMensajeBloqueo("No tienes acceso al módulo Conciliación bancaria.");
          setAutorizado(false);
        ...
        console.error("Error validando acceso a conciliación bancaria:", error);
        if (activo) {
          setMensajeBloqueo("No se pudo validar el acceso al módulo Conciliación bancaria.");
          setAutorizado(false);
          setValidandoAcceso(false);
        }
      }
          ...
          <header className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <h1 className="text-4xl md:text-5xl font-black">Conciliación bancaria</h1>
              ...
              <p className="mt-3 max-w-3xl text-[var(--muted)]">
                Base visual para conciliación entre bancos, movimientos internos y ajustes.
              </p>
            </div>

...
import { BarChart3, ClipboardList, FileText, Lock, ShieldCheck } from "lucide-react";
import Sidebar from "../../components/Sidebar";
import { validarAccesoModuloUsuario } from "../../lib/validarAccesoModuloUsuario";

const resumen = [
  { titulo: "Saldo real", valor: "Pendiente de conectar" },
  { titulo: "Saldo disponible", valor: "Sin conexión todavía" },
  { titulo: "Flujo proyectado", valor: "Pendiente de conectar" },
  { titulo: "Filtros previstos", valor: "Preparado para fase SQL" },
];
...
const funciones = [
  ...
  "IGSS",
  "Impuestos",
  "Filtros previstos: empresa, banco, moneda y proyecto",
];

const proximosPasos = [
  "Conectar saldos por cuenta bancaria",
  "Integrar pagos, cobros y cheques pendientes",
  "Preparar filtros por empresa, banco, moneda y proyecto",
  "Activar proyección de flujo en una rama posterior",
];
  ...
  useEffect(() => {
    ...
    async function iniciar() {
      try {
        ...
        console.error("Error validando acceso a flujo de efectivo:", error);
        if (activo) {
          setMensajeBloqueo("No se pudo validar el acceso al módulo Flujo de efectivo.");
          setAutorizado(false);
          setValidandoAcceso(false);
        }
      }
          ...
          <header className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <h1 className="text-4xl md:text-5xl font-black">Flujo de efectivo y fondos</h1>
              ...
              <p className="mt-3 max-w-3xl text-[var(--muted)]">
                Vista base para saldos, compromisos, proyecciones y filtros financieros previstos.
              </p>
            </div>

...
import { ClipboardList, FileText, Lock, Receipt, ShieldCheck } from "lucide-react";
import Sidebar from "../../components/Sidebar";
import { validarAccesoModuloUsuario } from "../../lib/validarAccesoModuloUsuario";

const resumen = [
  { titulo: "IVA compras / ventas", valor: "Pendiente de conectar" },
  { titulo: "ISR y retenciones", valor: "Sin conexión todavía" },
  { titulo: "Calendario fiscal", valor: "Pendiente de conectar" },
  { titulo: "Reportes fiscales", valor: "Preparado para fase SQL" },
];
...
const proximosPasos = [
  "Conectar documentos fiscales autorizados",
  "Preparar cálculo de IVA e ISR",
  "Vincular calendario fiscal",
  "Activar reportes y soportes en una rama posterior",
];
    ...
    async function iniciar() {
      try {
        ...
        if (!acceso.ok) {
          ...
          setMensajeBloqueo("No tienes acceso al módulo Impuestos.");
          setAutorizado(false);
        ...
        console.error("Error validando acceso a impuestos:", error);
        if (activo) {
          setMensajeBloqueo("No se pudo validar el acceso al módulo Impuestos.");
          setAutorizado(false);
          setValidandoAcceso(false);
        }
      }
          ...
          <header className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <h1 className="text-4xl md:text-5xl font-black">Impuestos</h1>
              ...
              <p className="mt-3 max-w-3xl text-[var(--muted)]">
                Control visual base para obligaciones fiscales, documentos soporte y reportes.
              </p>
            </div>

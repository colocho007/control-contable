...
import { Building2, ClipboardList, FileText, Lock, ShieldCheck } from "lucide-react";
import Sidebar from "../../components/Sidebar";
import { validarAccesoModuloUsuario } from "../../lib/validarAccesoModuloUsuario";

const resumen = [
  { titulo: "Proyectos / obras", valor: "Pendiente de conectar" },
  { titulo: "Centros de costo", valor: "Sin conexión todavía" },
  { titulo: "Presupuesto vs gasto", valor: "Pendiente de conectar" },
  { titulo: "Reportes ejecutivos", valor: "Preparado para fase SQL" },
];
...
const funciones = [
  ...
  "Presupuesto",
  "Gasto real",
  "Cheques por proyecto",
  "Planilla por proyecto",
  "Reportes ejecutivos",
];

const proximosPasos = [
  "Conectar catálogo de proyectos y centros de costo",
  "Vincular cheques y planilla por proyecto",
  "Preparar presupuesto contra ejecución",
  "Activar reportes ejecutivos en una rama posterior",
];
    ...
    async function iniciar() {
      try {
        ...
        if (!acceso.ok) {
          ...
          setMensajeBloqueo("No tienes acceso al módulo Proyectos.");
          setAutorizado(false);
        ...
        console.error("Error validando acceso a proyectos:", error);
        if (activo) {
          setMensajeBloqueo("No se pudo validar el acceso al módulo Proyectos.");
          setAutorizado(false);
          setValidandoAcceso(false);
        }
      }
          ...
          <header className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                <Building2 className="text-cyan-500" size={42} />
                <h1 className="text-4xl md:text-5xl font-black">Proyectos / centros de costo</h1>
              ...
              <p className="mt-3 max-w-3xl text-[var(--muted)]">
                Base visual para controlar proyectos, obras, centros de costo y ejecución.
              </p>
            </div>

# Inventario detallado de RPC y funciones de Supabase V1

- Proyecto: `control-contable`
- Rama: `fix/supabase-inventario-rpc-detallado-v1`
- Estado: inventario local detallado en construcción
...
- 0 sentencias locales de `REVOKE EXECUTE`;
